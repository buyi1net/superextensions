...
1. 加载 `express-agents`，按它定目标形态：结构、层级、完成标准、指针；
2. 翻译走下面「英译中」的两段式：先保真直译，再合上重说。注意「先翻译、再逐句修补」不是两段式，是事故：修补时眼睛还盯着原文，越修越英式；
...
第一段，保真直译。把原文的信息点一个不丢地搬进中文，腔调可以先不管，但骨架要先过一遍：长句拆短、名词化还原成动词。这份稿子不是成品，是意思的载体；骨架不处理，读它的人就得在脑子里做二次解析，白贵一重理解成本。

第二段，合上重说。合上原文和直译稿，带着读明白的意思，用中文把这件事说一遍，像转述给一个没看过原文的同事。第二段的起点是中文不是英文：从英式中文重说，比对着英文直译更容易摆脱英文骨架。这件事连不看英文的人都能干，说明它要的不是外语能力，是「把意思正常说一遍」的能力。

两段各有验收：

- 第一段对原文：信息点一个不丢；
- 第二段逐句回看：还能一个词一个词对回英文的，是翻译，重写；对不回去的，才是重说。终极验收是开口念一遍，听它像不像一个正常人正常说出来的话。

**重说之前，先辨语域**：原文这话是谁在对谁说（老师交代经验、工程师聊方案、产品经理写说明），换成中文里同身份的人怎么开口。术语跟着语域走：教材词在口语场景要落地，「工作记忆」说成「腾不出脑子」；术语在定义处保留原名，使用处说人话，「最近发展区」在专门讲它的那节保留，别处说成「学了就能用上」。英文的名词化短语，中文往往有现成的日常词等着：interacting with practitioners 是「实战」，CLI 是「命令行」，self-contained 是「独立的」。

**原理说成常识**：学科理论降成生活常理，主语跟着泛化，「学生大概率没办法一次性接受那么多新知识」说成「人一次记不住太多东西」。

**段落按意群聚合**：一句一段是英文的排版习惯，中文一个意思群写成一整段流畅的话，不拆成碎段。

**比喻立得住就留，落不了地就删**：「罗盘不是计划」立得住，留；「跳一跳能够着」还能再白，就删成「学了就能用上」。

**文风**：译完读起来，要像一个中文母语工程师在跟同事讲怎么干活。句子舒展，长短跟着内容走，该连就连、该断就断；连接词用活的口语（「要是」「就」「立马」），不端「当……时」「对……进行」那种腔；动词平实但有画面，「翻一段提交历史」「总在提交里冒头」「该收留它们的深模块」；规则引用点到为止，判断给个方向就收，细则让归属的 skill 去讲。
...
原文：Each lesson should recommend a primary source for the user to read or watch. This should be the most high-quality, high-trust resource you found on the topic.

不合格（词全对了，骨架还是英文的）：每课给用户推荐一个一手来源去读去看：你在这个主题上找到的质量最高、最可信的那个资源。

合格（合上重说）：每节课要推荐一份主要的阅读或观看材料，挑你在这个话题下能找到的质量最高、最信得过的资源。
...
- **术语统一**：同一概念全文一个译法，首次出现且可能歧义时标「中文（English）」。稳定译法查 [terms.md](./modules/terms.md)，表里没有的按语境定。术语想进受保护清单，先过语域检验：它是这个领域的行话，还是直译出来的黑话；行话保留，黑话落地。
...
| 可能暂时不做 | We may deprioritize this for now | We will never fix it |
